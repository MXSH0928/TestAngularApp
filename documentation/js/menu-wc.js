...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">test-angular-app documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-e247969be85e94927f912519c893607c"' : 'data-target="#xs-components-links-module-AppModule-e247969be85e94927f912519c893607c"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-e247969be85e94927f912519c893607c"' :
                                            'id="xs-components-links-module-AppModule-e247969be85e94927f912519c893607c"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/UserApiResponse.html" data-type="entity-link">UserApiResponse</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
